...
import io.angularpay.cipher.models.platform.*;
...
import static io.angularpay.cipher.exceptions.ErrorCode.INVALID_MESSAGE_ERROR;
import static io.angularpay.cipher.models.platform.PlatformConfigurationSource.HASH;
